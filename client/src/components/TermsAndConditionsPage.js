      ...
      <div className="container">
        ...
        <ul>
          ...
          <li><strong>Terms and Conditions</strong> (also referred as "Terms") mean these Terms and Conditions that form
            ...
            agreement as been created with the help of <a href="https://www.termsfeed.com/terms-conditions-generator/">Terms
          ...
          <li><strong>Website</strong> refers to Feedbuzz, accessible from https://feedbuzz-project.herokuapp.com</li>
        ...
        <ul>
          <li>By visiting this page on our website: https://feedbuzz-project.herokuapp.com/contact_us</li>
        </ul>
      </div>
  );
}
